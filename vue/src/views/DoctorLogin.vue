            ...
            <el-main width="50%">
                <div
                    ...
                    <div style="margin-top: 40px;">
                        <el-button @click="userloginindex()" style="margin-left: 40px;width: 100px;">用户登录</el-button>
                        <el-button type="primary" style="width: 100px;">医者登录</el-button>
                        <el-button @click="adminloginindex()" style="width: 100px;">管理登录</el-button>
                    </div>
...
export default {
    ...
    methods: {
        login() {
            request.post("/doctor/login", this.doctor).then(res => {
                if (res.code === '0') {
                    //成功跳转到首页
                    // 存储医生对象到localStorage
